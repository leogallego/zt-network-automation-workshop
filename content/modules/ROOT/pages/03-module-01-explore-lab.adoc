= Module 1: Exploring the Lab Environment
...
If you need more information on new Ansible Automation Platform components bookmark this landing page link:https://red.ht/AAP-20[https://red.ht/AAP-20^]
...
// TODO: Copy image from ansible-workshops/exercises/ansible_network/images/ansible_network_diagram.png
image::ansible_network_diagram.png[Red Hat Ansible Automation,align="center",link=self,window=blank,width=600]
...
// TODO: Copy image from ansible-workshops/exercises/ansible_network/1-explore/images/launch_page.png
image::launch_page.png[Launch page,align="center",link=self,window=blank,width=600]

Type in the provided password to connect.

// TODO: Copy image from ansible-workshops/exercises/ansible_network/1-explore/images/vscode_login.png
...
// TODO: Copy image from ansible-workshops/exercises/ansible_network/1-explore/images/vscode-networkworkshop.png
...
// TODO: Copy image from ansible-workshops/exercises/ansible_network/1-explore/images/vscode-playbook.png
...
// TODO: Copy image from ansible-workshops/exercises/ansible_network/1-explore/images/vscode-new-terminal.png
...
// TODO: Copy image from ansible-workshops/exercises/ansible_network/1-explore/images/navigator-images.png
...
// TODO: Copy image from ansible-workshops/exercises/ansible_network/1-explore/images/navigator-ee-menu.png
...
// TODO: Copy image from ansible-workshops/exercises/ansible_network/1-explore/images/navigator-ee-collections.png
...
// TODO: Copy image from ansible-workshops/exercises/ansible_network/1-explore/images/ansible-navigator.png
...
// TODO: Copy image from ansible-workshops/exercises/ansible_network/1-explore/images/ansible-navigator-groups.png
...
// TODO: Copy image from ansible-workshops/exercises/ansible_network/1-explore/images/ansible-navigator-rtr-1.png
...
There are 4 routers, named rtr1, rtr2, rtr3 and rtr4. The SSH configuration file (`~/.ssh/config`) is already setup on the control node. This means you can SSH to any router from the control node without a login:
